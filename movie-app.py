...
@st.cache_data
def load_similaritydata():
    gdown.download(id="1oobA87uEG1FwAO6xrTybo2XVNbAlEB5-",output='similarity.pk1',quiet=False)
    return pickle.load(open('similarity.pk1',mode='rb'))
...
<style>
.stApp {{
background: url("https://img.freepik.com/free-photo/abstract-luxury-gradient-blue-background-smooth-dark-blue-with-black-vignette-studio-banner_1258-56228.jpg?w=996&t=st=1678090810~exp=1678091410~hmac=bc0d56985b4c6c6f99aabb7af50d9cde0ad5edf26a496a7ee8069d02b5943d93");
...
title_image = Image.open(r"film-reel.png")
...
df = pd.read_csv(r"cleaned_movies.csv")
...
movies_dict = pickle.load(open(r'movies_dict.pk1', 'rb'))
similarity = load_similaritydata()
...
image = Image.open("tmdb-logo.png")
